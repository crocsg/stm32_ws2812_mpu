...
#ifndef _SD_HAL_MPU6050_H_
#define _SD_HAL_MPU6050_H_
...
typedef struct  {
	...
	I2C_HandleTypeDef* _i2c_dev; /* I2C device */
} SD_MPU6050;
...
/**
 * @brief  Enable Accelerometer data in fifo
 * @param  *DataStruct: Pointer to @ref SD_MPU6050_t structure to store data to
 * @retval Member of @ref SD_MPU6050_Result_t:
 ...
 * @param  *DataStruct: Pointer to @ref SD_MPU6050_t structure to store data to
 * @param  *size : pointer to store fifo size in bytes
 * @retval Number of samples in fifo
